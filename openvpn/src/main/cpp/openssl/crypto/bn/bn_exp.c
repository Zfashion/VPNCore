 ...
 * admob_ad_layout so that accessing any of these table values shows the same access
 ...
 * precomputation memory admob_ad_layout to limit data-dependency to a minimum to
