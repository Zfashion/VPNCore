...
public class LaunchVPN extends Activity {
    ...
    public static final String EXTRA_KEY = "com.blinkt.openvpn.shortcutProfileUUID";
    public static final String EXTRA_NAME = "com.blinkt.openvpn.shortcutProfileName";
    public static final String EXTRA_HIDELOG = "com.blinkt.openvpn.showNoLogWindow";
