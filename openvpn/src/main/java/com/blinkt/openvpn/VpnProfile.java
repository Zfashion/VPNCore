...
import com.blinkt.openvpn.core.OrbotHelper;
import com.blinkt.openvpn.core.PasswordCache;
...
public class VpnProfile implements Serializable, Cloneable {
    ...
    public static final String EXTRA_PROFILEUUID = "com.blinkt.openvpn.profileUUID";
...
//        }
    ...
    public Intent getStartServiceIntent(Context context) {
        ...
        Intent intent = OpenVPNImpl.getIntent(context);
        intent.putExtra(prefix + ".profileUUID", mUuid.toString());
        intent.putExtra(prefix + ".profileVersion", mVersion);
        return intent;
    }

    public Bundle getConnectData(Context context) {
        String prefix = context.getPackageName();
        Bundle data = new Bundle();
        data.putString(prefix + ".profileUUID", mUuid.toString());
        data.putInt(prefix + ".profileVersion", mVersion);
        return data;
    }
...
//        HashSet<String> pkgs = DataCfg.getAllowedApps();
//        apps.addAll(pkgs);
//        return apps;
//    }
}
