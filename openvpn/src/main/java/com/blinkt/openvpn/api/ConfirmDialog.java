...
public class ConfirmDialog extends Activity implements CompoundButton.OnCheckedChangeListener, DialogInterface.OnClickListener {
    ...
    public static final String ANONYMOUS_PACKAGE = "com.blinkt.openvpn.ANYPACKAGE";
...
//    };
    ...
    protected void onResume() {
        ...
        Intent serviceintent = OpenVPNImpl.getIntent(this);
        serviceintent.setAction(OpenVPNImpl.START_SERVICE);
//        bindService(serviceintent, mConnection, Context.BIND_AUTO_CREATE);
        ...
        try {
            ...
            if (mPackage.equals(ANONYMOUS_PACKAGE)) {
                appString = getString(R.string.all_app_prompt, getString(getApplicationInfo().labelRes));
            } else {
                PackageManager pm = getPackageManager();
                ApplicationInfo app = pm.getApplicationInfo(mPackage, 0);
                appString = getString(R.string.prompt, app.loadLabel(pm), getString(getApplicationInfo().labelRes));
