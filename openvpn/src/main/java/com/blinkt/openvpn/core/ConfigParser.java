    ...
    public void parseConfig(Reader reader) throws IOException, ConfigParseError {
        ...
        try {
            while (true) {
                ...
                Vector<String> args = parseline(line);//解析每一行
