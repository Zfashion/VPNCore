...
public class Connection implements Serializable, Cloneable {
    ...
    public static final int PT_SOCKS5 = 2;
    public static final int PT_ORBOT = 3;
    ...
    public void resetProxyType(){
        switch (mProType){
            case PT_NONE:
                mProxyType = ProxyType.NONE;
                break;
            case PT_HTTP:
                mProxyType = ProxyType.HTTP;
                break;
            case PT_SOCKS5:
                mProxyType = ProxyType.SOCKS5;
                break;
            case PT_ORBOT:
                mProxyType = ProxyType.ORBOT;
                break;
        }
    }
