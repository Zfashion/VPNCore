...
import static com.blinkt.openvpn.core.OpenVPNManagement.pauseReason;

public class DeviceStateReceiver extends BroadcastReceiver implements IVPN.ByteCountListener, OpenVPNManagement.PausedStateCallback {
