...
import com.blinkt.openvpn.api.ExternalCertificateProvider;
...
public class ExtAuthHelper {
    ...
    public static final String ACTION_CERT_CONFIGURATION = "com.blinkt.openvpn.api.ExternalCertificateConfiguration";
    public static final String ACTION_CERT_PROVIDER = "com.blinkt.openvpn.api.ExternalCertificateProvider";

    public static final String EXTRA_ALIAS = "com.blinkt.openvpn.api.KEY_ALIAS";
    public static final String EXTRA_DESCRIPTION = "com.blinkt.openvpn.api.KEY_DESCRIPTION";
    ...
    public static class ExternalAuthProviderConnection implements Closeable {
        ...
        protected ExternalAuthProviderConnection(Context context, ServiceConnection serviceConnection, ExternalCertificateProvider service) {
