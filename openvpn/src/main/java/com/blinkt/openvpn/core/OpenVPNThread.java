...
public class OpenVPNThread implements Runnable {
    ...
    private static final String BROKEN_PIE_SUPPORT = "/data/data/com.blinkt.openvpn/cache/pievpn";
    ...
    private OpenVPNImpl mVPNImpl;
    private String mDumpPath;
    private boolean mBrokenPie = false;
    private boolean mNoProcessExitStatus = false;

    public OpenVPNThread(OpenVPNImpl service, String[] argv, String nativelibdir) {
        mArgv = argv;
            ...
            if (mDumpPath != null) {
                try {
                    ...
                    for (LogItem li : VpnStatus.getlogbuffer()) {
                        ...
                        logout.write(time + " " + li.getString(mVPNImpl.getContext()) + "\n");
                    }
                    logout.close();
