...
public class VpnStatus {
    ...
    private static Vector<IVPN.ByteCountListener> byteCountListener;
    ...
    public static boolean isVPNActive() {
        return mLastLevel != ConnectionStatus.LEVEL_AUTH_FAILED
                ...
                && mLastLevel != ConnectionStatus.UNKNOWN_LEVEL;
    }
...
*/
    ...
    public static void setConnectedVPNProfile(String uuid) {
        ...
        if (stateListener != null) {
            Iterator<StateListener> iterator = stateListener.iterator();
            StateListener stateListener;
            while (iterator.hasNext()) {
                stateListener = iterator.next();
                stateListener.setConnectedVPN(uuid);
            }
        }
...
//            sl.setConnectedVPN(uuid);
    ...
    private static ConnectionStatus mLastLevel = ConnectionStatus.UNKNOWN_LEVEL;
    ...
    public synchronized static void addByteCountListener(IVPN.ByteCountListener bcl) {
    ...
    public synchronized static void removeByteCountListener(IVPN.ByteCountListener bcl) {
    ...
    synchronized static void newLogItem(LogItem logItem, boolean cachedLine) {
        ...
        //if (com.sino.app.anyvpn.utils.AppLog.isDebug && !cachedLine && !BuildConfig.FLAVOR.equals("test"))
    ...
    public static synchronized void updateByteCount(long in, long out) {
        ...
        for (IVPN.ByteCountListener bcl : byteCountListener) {
