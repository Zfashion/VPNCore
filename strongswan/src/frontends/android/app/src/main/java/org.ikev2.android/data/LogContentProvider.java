...
package org.ikev2.android.data;
...
{
	//private static final String AUTHORITY = "com.any.vpn.android.content.log";
	...
	{
		mLogFile = new File(getContext().getFilesDir(), Ikev2VPNImpl.LOG_FILE);
		return true;
	}
	...
	public static Uri createContentUri(Context context)
	{
		...
		String AUTHORITY = context.getPackageName()+".LogProvider";
						...
						String[] selectionArgs, String sortOrder)
	{
		...
		{
			cursor.newRow().add(Ikev2VPNImpl.LOG_FILE);
		}
